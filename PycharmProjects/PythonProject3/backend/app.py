...
def predict(txn: Transaction):
    try:
        ...
        shap_contrib = shap_values.values[0][:, prediction_code]  # select predicted class values
        ...
        if rule_based_result in ["APP Fraud", "ATO + RTP Drain"] or prediction_code in [1, 2]:
